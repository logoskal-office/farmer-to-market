...
class Farmer(models.Model):
    ...
    phone_number = models.CharField(max_length=9, null=True, blank=True, validators=[phone_number_validator])
    ...
    def __str__(self):
        return f'{self.account.first_name} {self.account.last_name} ({self.id})'
