...
from .views import profile_update, profile, farmer_products_list, farmer_products_detail, farmer_product_delete, create_product
...
urlpatterns = [
    ...
    path('product/create/', create_product, name='farmer-product-create')
]